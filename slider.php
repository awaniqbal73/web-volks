...
<head>
  <title>Home Basic 5 | Panatacorporation - Responsive Website Template</title>
...
<body class="header-fixed header-fixed-space-v2">
  <div class="wrapper">
    ...
    <div class="interactive-slider-v2 img-v4">
      <div class="container">
        <h1>Welcome to Panatacorporation</h1>
      ...
      <div class="container">
        <div class="call-action-v1-box">
          <div class="call-action-v1-in">
            ...
            <p>Panatacorporation creative technology company providing key digital services and focused on helping our clients to build a successful business on web and mobile.</p>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="headline-left margin-bottom-30">
                <h2 class="headline-brd">WE ARE Panatacorporation AGENCY</h2>
          ...
          <div class="row">
            <div class="col-md-7 md-margin-bottom-60">
              <div class="headline-left margin-bottom-20">
                <h2 class="headline-brd">Panatacorporation is Fully Responsive</h2>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-3 col-sm-6 column-one md-margin-bottom-50">
              ...
              <p class="margin-bottom-20">Panatacorporation is an ultra fully responsive template with modern and smart design.</p>
      ...
      <div class="cd-user-modal-container"> <!-- this is the container wrapper -->
        ...
        <div id="cd-login"> <!-- log in form -->
          <form class="cd-form">
            ...
            <div class="lined-text"><span>Or use your account on Panatacorporation</span><hr></div>
        ...
        <div id="cd-signup"> <!-- sign up form -->
          <form class="cd-form">
            ...
            <div class="lined-text"><span>Or register your new account on Panatacorporation</span><hr></div>
